...
void vp8_dc_only_idct_add_mmi(short input_dc, unsigned char * pred,
                              int pred_stride, unsigned char *dst_ptr,
                              int dst_stride);

void vp8_dequant_idct_add_y_block_mmi(short *q, short *dq,
                                      unsigned char *dst,
...
void vp8_dequant_idct_add_uv_block_mmi(short *q, short *dq,
                                       unsigned char *dstu,
                                       unsigned char *dstv,
                                       int stride, char *eobs)
{
