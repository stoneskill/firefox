...
void WebRtcIsacfix_MatrixProduct1MIPS(const int16_t matrix0[],
  ...
  if (matrix1_index_init_case != 0) {
    ...
    __asm __volatile (
      ...
      ".set     noreorder                                                  \n\t"
     "1:                                                                   \n\t"
      PTR_ADDU "%[product_ptr],     %[product_start],     $0               \n\t"
      "addu     %[k],               %[product_step],      $0               \n\t"
      "addiu    %[j],               %[j],                 -1               \n\t"
      PTR_ADDU "%[matrix1_start],   %[matrix1],           $0               \n\t"
     "2:                                                                   \n\t"
      PTR_ADDU "%[matrix1_ptr],     %[matrix1_start],     $0               \n\t"
      PTR_ADDU "%[matrix0_ptr],     %[matrix0_start],     $0               \n\t"
     ...
     "3:                                                                   \n\t"
      ...
      "sra      %[r0],              %[r0],                16               \n\t"
      "mul      %[r0],              %[r0],                %[r1]            \n\t"
      PTR_ADDU "%[matrix0_ptr],     %[matrix0_ptr],       %[matrix0_step]  \n\t"
      "addiu    %[n],               %[n],                 -1               \n\t"
      ...
      " addu    %[sum32],           %[sum32],             %[r0]            \n\t"
      "addiu    %[k],               %[k],                 -4               \n\t"
      PTR_ADDU "%[matrix1_start],   %[matrix1_start],     %[matrix1_step2] \n\t"
      "sw       %[sum32],           0(%[product_ptr])                      \n\t"
      "bgtz     %[k],               2b                                     \n\t"
      PTR_ADDIU"%[product_ptr],     %[product_ptr],       4                \n\t"
      PTR_ADDU "%[matrix0_start],   %[matrix0_start],     %[matrix0_step2] \n\t"
      "bgtz     %[j],               1b                                     \n\t"
      PTR_ADDU "%[product_start],   %[product_start],     %[product_step]  \n\t"
      ".set     pop                                                        \n\t"
    ...
    __asm __volatile (
     ...
     "1:                                                                   \n\t"
      ...
      "addu     %[k],               %[product_step],      $0               \n\t"
      "addiu    %[j],               %[j],                 -1               \n\t"
      PTR_ADDU "%[matrix0_start],   %[matrix0],           $0               \n\t"
     "2:                                                                   \n\t"
      PTR_ADDU "%[matrix1_ptr],     %[matrix1_start],     $0               \n\t"
      PTR_ADDU "%[matrix0_ptr],     %[matrix0_start],     $0               \n\t"
      "addu     %[n],               %[inner_loop_count],  $0               \n\t"
     ...
     "3:                                                                   \n\t"
      "lw       %[r0],              0(%[matrix1_ptr])                      \n\t"
      "lh       %[r1],              0(%[matrix0_ptr])                      \n\t"
      PTR_ADDU "%[matrix1_ptr],     %[matrix1_ptr],       %[matrix1_step]  \n\t"
      "sllv     %[r0],              %[r0],                %[shift]         \n\t"
      "andi     %[r2],              %[r0],                0xffff           \n\t"
      "sra      %[r2],              %[r2],                1                \n\t"
      "mul      %[r2],              %[r2],                %[r1]            \n\t"
...
void WebRtcIsacfix_MatrixProduct2MIPS(const int16_t matrix0[],
  ...
  __asm __volatile (
    ...
    PTR_ADDU   "%[matrix0_start],  %[matrix0],        $0               \n\t"
   "1:                                                                 \n\t"
    PTR_ADDU   "%[matrix1_ptr],    %[matrix1],        $0               \n\t"
    PTR_ADDU   "%[matrix0_ptr],    %[matrix0_start],  $0               \n\t"
    "addu       %[n],              %[loop_count],     $0               \n\t"
    "mul        %[sum32],          $0,                $0               \n\t"
    "mul        %[sum32_2],        $0,                $0               \n\t"
   "2:                                                                 \n\t"
    ...
    "sra        %[r4],             %[r4],             15               \n\t"
#endif
    PTR_ADDU   "%[matrix1_ptr],    %[matrix1_ptr],    8                \n\t"
    PTR_ADDU   "%[matrix0_ptr],    %[matrix0_ptr],    %[matrix0_step]  \n\t"
    "addiu      %[n],              %[n],              -1               \n\t"
    "addu       %[sum32],          %[sum32],          %[r3]            \n\t"
    ...
    "bgtz       %[j],              1b                                  \n\t"
    PTR_ADDIU  "%[matrix_product], %[matrix_product], 8                \n\t"
    ".set       pop                                                    \n\t"
