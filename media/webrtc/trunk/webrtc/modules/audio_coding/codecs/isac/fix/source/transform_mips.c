...
void WebRtcIsacfix_Time2SpecMIPS(int16_t* inre1Q9,
  ...
  mips_reg r0, r1, r2, r3, r4, r5, r6, r7, r8, r9;
  mips_reg inre1, inre2, tmpre, tmpim;
  int32_t factor, max, max1;
  int16_t* cosptr;
  int16_t* sinptr;
  ...
  __asm __volatile (
    ".set           push                                      \n\t"
    ".set           noreorder                                 \n\t"
    PTR_ADDIU      "%[inre1],     %[inre1Q9],   0             \n\t"
    PTR_ADDIU      "%[inre2],     %[inre2Q9],   0             \n\t"
    PTR_ADDIU      "%[tmpre],     %[tmpreQ16],  0             \n\t"
    PTR_ADDIU      "%[tmpim],     %[tmpimQ16],  0             \n\t"
   ...
   "1:                                                        \n\t"
    ...
    "extr_r.w       %[r4],        $ac0,         16            \n\t"
    "extr_r.w       %[r5],        $ac1,         16            \n\t"
    PTR_ADDIU      "%[inre1],     %[inre1],     4             \n\t"
    PTR_ADDIU      "%[inre2],     %[inre2],     4             \n\t"
    "extr_r.w       %[r6],        $ac2,         16            \n\t"
    "extr_r.w       %[r7],        $ac3,         16            \n\t"
    PTR_ADDIU      "%[cosptr],    %[cosptr],    4             \n\t"
    PTR_ADDIU      "%[sinptr],    %[sinptr],    4             \n\t"
    "shra_r.w       %[r4],        %[r4],        3             \n\t"
    "shra_r.w       %[r5],        %[r5],        3             \n\t"
    "sw             %[r4],        0(%[tmpre])                 \n\t"
    "absq_s.w       %[r4],        %[r4]                       \n\t"
    ...
    "slt            %[r1],        %[max],       %[r6]         \n\t"
    "movn           %[max],       %[r6],        %[r1]         \n\t"
    PTR_ADDIU      "%[tmpre],     %[tmpre],     8             \n\t"
    "bgtz           %[k],         1b                          \n\t"
    PTR_ADDIU      "%[tmpim],     %[tmpim],     8             \n\t"
    ...
    "mul            %[r0],        %[r0],        %[r3]         \n\t"
    "mul            %[r2],        %[r1],        %[r2]         \n\t"
    PTR_ADDIU      "%[inre1],     %[inre1],     2             \n\t"
    PTR_ADDIU      "%[inre2],     %[inre2],     2             \n\t"
    PTR_ADDIU      "%[cosptr],    %[cosptr],    2             \n\t"
    PTR_ADDIU      "%[sinptr],    %[sinptr],    2             \n\t"
    "addu           %[r1],        %[r4],        %[r5]         \n\t"
    "sra            %[r1],        %[r1],        7             \n\t"
    "sra            %[r3],        %[r1],        16            \n\t"
    "andi           %[r1],        %[r1],        0xFFFF        \n\t"
  ...
  __asm __volatile (
    ...
    PTR_ADDIU      "%[inre1],     %[inre1Q9],   0             \n\t"
    PTR_ADDIU      "%[inre2],     %[inre2Q9],   0             \n\t"
    PTR_ADDIU      "%[tmpre],     %[outreQ7],   0             \n\t"
    PTR_ADDIU      "%[tmpim],     %[outimQ7],   0             \n\t"
    "bltz           %[max],       2f                          \n\t"
    " subu          %[max1],      $zero,        %[max]        \n\t"
   "1:                                                        \n\t"
#if !defined(MIPS_DSP_R1_LE)
    PTR_ADDU       "%[r4],        %[inre1],     %[offset]     \n\t"
    PTR_ADDU       "%[r5],        %[inre2],     %[offset]     \n\t"
#endif  // #if !defined(MIPS_DSP_R1_LE)
    "lh             %[r0],        0(%[inre1])                 \n\t"
    "lh             %[r1],        0(%[inre2])                 \n\t"
#if defined(MIPS_DSP_R1_LE)
    ...
    "sll            %[r0],        %[r0],        2             \n\t"
    "addu           %[r0],        %[r0],        %[r6]         \n\t"
    PTR_ADDU       "%[r3],        %[tmpre],     %[offset]     \n\t"
    PTR_ADDU       "%[r2],        %[tmpim],     %[offset]     \n\t"
    "addu           %[r9],        %[r9],        %[r8]         \n\t"
    "negu           %[r9],        %[r9]                       \n\t"
    "sra            %[r9],        %[r9],        9             \n\t"
    "subu           %[r0],        %[r0],        %[r1]         \n\t"
    ...
    "sh             %[r9],        0(%[r3])                    \n\t"
    "sh             %[r0],        0(%[r2])                    \n\t"
    PTR_ADDIU      "%[tmpre],     %[tmpre],     2             \n\t"
    "bgtz           %[k],         1b                          \n\t"
    PTR_ADDIU      "%[tmpim],     %[tmpim],     2             \n\t"
    "b              3f                                        \n\t"
    " nop                                                     \n\t"
   "2:                                                        \n\t"
#if !defined(MIPS_DSP_R1_LE)
...
void WebRtcIsacfix_Spec2TimeMIPS(int16_t *inreQ7,
  ...
  mips_reg r0, r1, r2, r3, r4, r5, r6, r7, r8, r9, r10, max, max1;
#if defined(MIPS_DSP_R1_LE)
  mips_reg offset = FRAMESAMPLES - 4;
#else  // #if defined(MIPS_DSP_R1_LE)
  mips_reg offset = FRAMESAMPLES - 2;
#endif  // #if defined(MIPS_DSP_R1_LE)

  __asm __volatile (
    ".set           push                                      \n\t"
    ".set           noreorder                                 \n\t"
    PTR_ADDIU      "%[inre],      %[inreQ7],    0             \n\t"
    PTR_ADDIU      "%[inim] ,     %[inimQ7],    0             \n\t"
    PTR_ADDIU      "%[outre1],    %[outre1Q16], 0             \n\t"
    PTR_ADDIU      "%[outre2],    %[outre2Q16], 0             \n\t"
    "mul            %[max],       $zero,        $zero         \n\t"
   "1:                                                        \n\t"
#if defined(MIPS_DSP_R1_LE)
    ...
    PTR_ADDU       "%[r8],        %[inre],      %[offset]     \n\t"
    PTR_ADDU       "%[r9],        %[inim],      %[offset]     \n\t"
    "lwl            %[r4],        0(%[r8])                    \n\t"
    "lwl            %[r5],        0(%[r9])                    \n\t"
    "lwl            %[r0],        0(%[inre])                  \n\t"
    "lwl            %[r1],        0(%[inim])                  \n\t"
    ...
    PTR_ADDIU      "%[cosptr],    %[cosptr],    4             \n\t"
    PTR_ADDIU      "%[sinptr],    %[sinptr],    4             \n\t"
    PTR_ADDIU      "%[inre],      %[inre],      4             \n\t"
    PTR_ADDIU      "%[inim],      %[inim],      4             \n\t"
    "shra_r.w       %[r6],        %[r6],        6             \n\t"
    "shra_r.w       %[r7],        %[r7],        6             \n\t"
    "shra_r.w       %[r8],        %[r8],        6             \n\t"
    "shra_r.w       %[r9],        %[r9],        6             \n\t"
    ...
    "subu           %[r7],        %[r6],        %[r9]         \n\t"
    "addu           %[r6],        %[r6],        %[r9]         \n\t"
    PTR_SLL        "%[r10],       %[offset],    1             \n\t"
    PTR_ADDU       "%[r10],       %[outre1],    %[r10]        \n\t"
    "sw             %[r7],        0(%[outre1])                \n\t"
    "absq_s.w       %[r7],        %[r7]                       \n\t"
    "sw             %[r6],        4(%[r10])                   \n\t"
    "absq_s.w       %[r6],        %[r6]                       \n\t"
    ...
    "subu           %[r1],       %[r1],         %[r0]         \n\t"
    "sll            %[r0],       %[offset],     1             \n\t"
    PTR_ADDU       "%[r4],       %[outre1],     %[r0]         \n\t"
    PTR_ADDU       "%[r5],       %[outre2],     %[r0]         \n\t"
    PTR_ADDIU      "%[r8],       %[r8],         16            \n\t"
    PTR_SRA        "%[r8],       %[r8],         5             \n\t"
    "addiu          %[r7],       %[r7],         16            \n\t"
    "sra            %[r7],       %[r7],         5             \n\t"
    ...
    "sw             %[r3],       0(%[outre2])                 \n\t"
    "sw             %[r1],       0(%[r5])                     \n\t"
    PTR_ADDIU      "%[outre1],   %[outre1],     4             \n\t"
    PTR_ADDIU      "%[offset],   %[offset],     -4            \n\t"
    PTR_ADDIU      "%[inre],     %[inre],       2             \n\t"
    PTR_ADDIU      "%[inim],     %[inim],       2             \n\t"
