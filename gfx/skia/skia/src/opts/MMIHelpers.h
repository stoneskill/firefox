...
static inline __m128i _mm_loadu_cvtsi16_si128(const int16_t*ptr)
{
    __m128i v;
    int32_t x;
...
static inline __m128i _mm_loadu_cvtsi32_si128(const int32_t*ptr)
{
    __m128i v;
...
static inline __m128i _mm_srli_si128(__m128i a, int32_t shift)
{
    ...
    shift = shift > 15 ? 16 : shift;
    if (shift > 8) {
	    *(uint64_t *) &s = (shift - 8) << 3;
